...
internal sealed class DeleteCustomerComandHandler : IRequestHandler<DeleteCustomerCommand, ErrorOr<Unit>>
{
    private readonly ICustomerRepository _customerRepository;
    private readonly IUnitOfWork _unitOfWork;

    public DeleteCustomerComandHandler(ICustomerRepository customerRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<ErrorOr<Unit>> Handle(DeleteCustomerCommand command, CancellationToken cancellationToken)
    {
        ...
        {
            return Error.NotFound("Customer.NotFound", "The customer provide ID was not found.");
        }
